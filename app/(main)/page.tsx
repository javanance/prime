                    ...
                    <ul className="p-0 m-0 border-none list-none">
                        <li className="flex align-items-center py-3">
                            <div className="flex align-items-center">
                                ...
                                <div className="ml-2">
                                    <div>Xuxue Feng</div>
                                    <small className="text-color-secondary">feng@ultima.org</small>
                                </div>
                            </div>
                        ...
                        <li className="flex align-items-center py-3">
                            <div className="flex align-items-center">
                                ...
                                <div className="ml-2">
                                    ...
                                    <small className="text-color-secondary">sharvill@ultima.org</small>
                                </div>
                            </div>
                        ...
                        <li className="flex align-items-center py-3">
                            <div className="flex align-items-center">
                                ...
                                <div className="ml-2">
                                    <div>Anna Fali</div>
                                    <small className="text-color-secondary">fali@ultima.org</small>
                                </div>
                            </div>
                        ...
                        <li className="flex align-items-center py-3">
                            <div className="flex align-items-center">
                                ...
                                <div className="ml-2">
                                    <div>Jon Stone</div>
                                    <small className="text-color-secondary">stone@ultima.org</small>
                                </div>
                            </div>
                            <span className="bg-pink-500 p-1 text-sm font-medium text-white border-round-xs ml-auto">Management</span>
                        ...
                        <li className="flex align-items-center py-3">
                            <div className="flex align-items-center">
                                ...
                                <div className="ml-2">
                                    ...
                                    <small className="text-color-secondary">shaw@ultima.org</small>
                                </div>
                            </div>
                            <span className="bg-teal-500 p-1 text-sm font-medium text-white border-round-xs ml-auto">Finance</span>
                        </li>
